...
mod tests {
    ...
    use crate::{
        ChangeProductionSystem, Data, DynamicType, Events, Fields, ProductionSystem, Propierties,
        Target, UnitData, UnitProcess, contract_logic,
    };
    use kore_contract_sdk as sdk;
    use serde_json::json;
